namespace SinemaOto
{
    partial class FrmYonetmenKayit
    {
        ...
        private void InitializeComponent()
        {
            ...
            label2.TabIndex = 5;
            label2.Text = "Yönetmen kayıt Formu";
            ...
            groupBox1.Location = new Point(312, 130);
            ...
            rbkadın.Size = new Size(83, 32);
            rbkadın.TabIndex = 15;
            rbkadın.Text = "Kadın";
            rbkadın.UseVisualStyleBackColor = true;
            rbkadın.CheckedChanged += radioButton2_CheckedChanged;
            // 
            // pictureBox1
            // 
            ...
            nyil.Name = "nyil";
            nyil.Size = new Size(79, 34);
            nyil.TabIndex = 12;
            nyil.Value = new decimal(new int[] { 2003, 0, 0, 0 });
            nyil.ValueChanged += numericUpDown3_ValueChanged;
            // 
            // nay
            // 
            ...
            soyadtext.TextChanged += textBox2_TextChanged;
            // 
            // label4
            // 
